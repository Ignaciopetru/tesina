...
\begin{itemize}
    ...
    \item Otra forma se basa en verificar si el valor es permitido, haciendo que la función retorne un valor inidicando el resultado de la validación, 0 en caso afirmativo o -1 en caso contrario. Este enfoque es mejor que no realizar manejo alguno, pero como se comentó en el principio, se está acoplando al usuario de la función con el módulo que la exporta, ya que este tiene que verificar el valor de retorno para determinar si existió un error o no.
\end{itemize}
