...
\umlclass[right=4cm of Microondas]{EstadoMicroondas}
{}
{
prender() \\
cancelar() \\
...
\umlclass[below left=2cm and -4cm of EstadoMicroondas]{Calentando}
{
...
\umlclass[right=2cm of StockProxy]{ErrorHandler}
{
}
{
