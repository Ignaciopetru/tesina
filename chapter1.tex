...
\umlnote[above right=-1cm and 1cm of Temporizador,width=3cm]{Temporizador}{
tickHandler() \{ \\
\ \ \ \ botonTime.execute() \\
\}
}
...
\begin{figure}[H]
\caption{Módulos de un subsistema de control y el componente al que pertenecen.}
\label{modulosSub}
\begin{center}
\begin{tikzpicture}\sf
