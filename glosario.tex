...
\newacronym{MCU}{MCU}{Microcontrolador}
...
\newacronym{IS}{IS}{Ingeniería de Software}
\newacronym{CSP}{CSP}{Sistemas ciber-físicos}
...
\newglossaryentry{magnetron}{
name={magnetrón},
description={Un magnetrón es un tubo electrónico al vacío que genera microondas mediante la interacción de electrones acelerados en un campo eléctrico y confinados por un campo magnético. Es el componente central de los hornos de microondas, siendo el responsable de producir las ondas electromagnéticas que calientan los alimentos. También se utiliza en equipos de radar para generar pulsos de alta potencia}
}

\newglossaryentry{pasoapaso}{
name={motor paso a paso},
plural={motores paso a paso},
description={Un motor paso a paso es un tipo de motor eléctrico que convierte señales eléctricas en movimientos mecánicos discretos y precisos. A diferencia de los motores tradicionales, se mueve en pasos fijos en lugar de girar continuamente, lo que permite controlar con exactitud el ángulo de rotación sin necesidad de sensores. Esto lo hace ideal para aplicaciones que requieren posicionamiento preciso, como impresoras 3D, robótica, CNC y automatización industrial}
}
...
\newglossaryentry{bit}{
name={Bit flip},
description={Un "bit flip" (o inversión de bits) en informática se refiere a un error donde el valor de un bit (un dígito binario, 0 o 1) cambia a su opuesto. En otras palabras, un 0 se convierte en 1, o viceversa. Este cambio puede ocurrir debido a diversos factores, como errores de hardware (memoria defectuosa, sobrecalentamiento) o errores de software}
}

\newglossaryentry{servomecanismos}{
name={servomecanismos},
description={Un servomecanismo es un sistema de control automático que utiliza retroalimentación para regular con precisión la posición, velocidad o aceleración de un actuador, como un motor. Está compuesto típicamente por un motor, un sensor (como un potenciómetro o encoder) y un controlador que ajusta la señal de entrada en función del error entre la posición deseada y la real. Los servomecanismos se usan ampliamente en robótica, automatización industrial y sistemas embebidos donde se requiere movimiento controlado y exacto}
}

\newglossaryentry{checksum}{
name={checksum},
description={Un checksum, o suma de verificación, es un valor numérico calculado a partir de un conjunto de datos que se utiliza para verificar la integridad de la información durante su transmisión o almacenamiento. Su propósito es asegurar que los datos no se hayan alterado o dañado de forma accidental}
}
