...
%\DeclareCaptionType{code}[Code Listing][Índice de códigos] 
...
\title{Patrones de diseño aplicados a sistemas embebidos de control}
...
\Degree{Licenciatura en Ciencias de la Computación}{Departamento de Ciencias de la Computación}
%\Degree{Master of Science in Physics}{}
%\Degree{Bachelor of Science in Mechanical Engineering}{Department of Mechanical Engineering}

% If there is more than one supervisor, use the \Supervisor command for each.
\Supervisor{Laura Pomponio}{Licenciada en Ciencias de la Computación}
...
\vfill
\end{center}
{\itshape\Large Alumno: \par}
{\Large Petruskevicius Ignacio\par}
\rule{5.62cm}{0.3mm}

\noindent
{\itshape\Large Directora: \par}
\noindent
{\Large Pomponio Laura\par}
\vspace{1cm}
\begin{center}
{Mayo 2025 \par}
\end{center}
