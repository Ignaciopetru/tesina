...
\Author{Ignacio Tomás Petruskevicius}{}[]
...
\Supervisor{Laura Pomponio}{Doctora}
...
\end{center}
{\textit{Alumno}: \par}
{\Large Petruskevicius Ignacio Tomás\par}
\rule{7cm}{0.3mm}
\vspace{2mm}
...
\cleardoublepage
\phantomsection
\addcontentsline{toc}{frontmatter}{\lstlistlistingname}
\lstlistoflistings
%%% Chapters of thesis  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
